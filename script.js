document.addEventListener('DOMContentLoaded', () => {
    ...
    class Confetti {
        constructor() {
            ...
            this.color = Math.random() > 0.5 ? '#FFC93C' : '#F9A826';
    ...
    btnFollow.addEventListener('click', () => {
        ...
        sessionStorage.setItem("waitingReturn", "true");

        window.open(
            "https://facebook.com/SMAEMedia.HaUI?locale=vi_VN",
            "_blank"
        );
    ...
    function beginLoading() {
        ...
        sessionStorage.removeItem("waitingReturn");
    ...
    window.addEventListener("focus", () => {
        ...
        if (sessionStorage.getItem("waitingReturn") === "true") {
            beginLoading();
        }
    ...
    document.addEventListener("visibilitychange", () => {
        ...
        if (!document.hidden &&
            sessionStorage.getItem("waitingReturn") === "true") {
    ...
    function startLoadingSequence() {
        ...
        const totalDuration = 15000; // 15 giây
        ...
        const timer = setInterval(() => {
            ...
            // Chuyển sang nhân vật tốt nghiệp ở 90%
